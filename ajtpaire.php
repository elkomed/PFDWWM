...
if(!isset($_POST['password']) OR $_POST['password'] != "123456")//si le champ password est vide ou est différent du mdp définit, la page d'identification reste affichée
{
?>
...
}else{ // sinon on affiche le formulaire d'ajout de Articles
?>

<fieldset>
 
<form action="./ajoutpaire.php" method="POST">  
                                                     
<!--on redirige le formulaire vers la fonction ajoutpaire qui contient nos requetes permettant d'importer le contenu dans la bdd-->
<div id="formulaire">
      <div class="input-form">
      ...
      <div class="input-form">
         <label class="naissance" for="photo">Photos</label>
        <input type="file" id="photo" name="photo" accept="image/png, image/jpeg, image/jpg">

      </div>
      
      <div class="submit-form">
        <button type="submit">Vlider</button>
      </div>
</div>
</form>
</fieldset>
