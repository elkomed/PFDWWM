...
if (isset($_SESSION['username'])) {
    echo  "<script>document.getElementById('sessionmob').innerHTML = 'Bonjour $_SESSION[username]';
    </script>";
  } else {
    echo  "<script>document.getElementById('sessionmob').innerHTML = 'Non connecté';
    </script>";
  }
?></p></li>
...
if (isset($_SESSION['username'])) {
    ...
    echo  "<script>document.getElementById('sessionmob').innerHTML = 'pas connecté';
    </script>";
  } 
?>
...
if (isset($_SESSION['username'])) {
    echo  "<script>document.getElementById('session').innerHTML = 'BONJOUR $_SESSION[username]';
    </script>";
  } else {
    echo  "<script>document.getElementById('session').innerHTML = 'Non connecté';
    </script>";
  }
?></p>
