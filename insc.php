...
$errors = array();
    ...
    //vérifie si le mot de passe est inferieur à 10 , et si c'est le cas l'instruction 
    //n'est pas validée
        echo 'faux5';
    }
    ...
    //vérifie si le user_pass est différent de confirm_pass et si c'est le cas 
    //l'instruction n'est pas validée
        echo 'faux7';
    }
    else{
        ...
        // récupère le mot de passe entrée et le stock dans une variable , pour le crypter avec 
        //la méthode PASSWORD_BCRYPT , qui utilise le hash Blowfish.
